                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold"><counter-value :target="{{ $tickets->count() }}"></counter-value></h2>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold"><counter-value :target="{{ $tickets->pending()->count() }}"></counter-value></h2>
                            <p class="mb-0 text-muted">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold"><counter-value :target="{{ $tickets->closed()->count() }}"></counter-value></h2>
                            <p class="mb-0 text-muted">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold"><counter-value :target="{{ $tickets->withTrashed()->count() }}"></counter-value></h2>
                            <p class="mb-0 text-muted">
